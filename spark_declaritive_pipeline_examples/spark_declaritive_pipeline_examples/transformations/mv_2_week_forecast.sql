CREATE OR REFRESH MATERIALIZED VIEW leigh_robertson_demo.gold_noaa.forecasts_high_low_ldp_databricks_example
SELECT 
  forecasts.startTime,
  zip_code.place_name,
  zip_code.state,
...
FROM leigh_robertson_demo.silver_noaa.forecasts_expanded_ldp_databricks_example AS forecasts
